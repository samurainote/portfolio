...
### 4. Kaggle Challenges: Prediction by Machine Learning ディープラーニングと機械学習を用いた予測モデル
...
- #### Regression 回帰 × 予測
  ...
  - [Regression: Multi-layerNN_for_Regression_BHP](https://github.com/samurainote/Multi-layerNN_for_Regression_BHP) 多層ニューラルネットワークによるによるボストン地区の不動産価格予測.
...
### 5. Machine Learning Foundation 機械学習のワークフロー Github&Medium
